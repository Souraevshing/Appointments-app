...
const AddAppointments = ({ onSendAppointments, lastId }) => {
  ...
  return (
    <div>
      <button
        onClick={() => setIsFormChecked(!isFormChecked)}
        className={`bg-blue-400 text-white px-2 py-3 w-full text-left rounded-md ${
          isFormChecked ? 'rounded-t-md' : 'rounded-md'
        }`}
      >
        <div>
